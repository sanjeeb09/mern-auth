...
export default function About() {
  return (
    ...
    <p className='mb-4 text-slate-700'>
      This application is intended for  educational purposes and should not be used
      for any serious or production applications without proper security measures.
      This application is made on 1st February,2024 only for Ginger Media group Placement Task.
    </p>
  </div>
);
}
